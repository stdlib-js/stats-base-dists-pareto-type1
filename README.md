...
```javascript
import pareto1 from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dists-pareto-type1@v0.2.2-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { Pareto1, cdf, entropy, kurtosis, logcdf, logpdf, mean, median, mode, pdf, quantile, skewness, stdev, variance } from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dists-pareto-type1@v0.2.2-deno/mod.js';
```
